...
test("v3.5.2 release markers and cache version stay synchronized",()=>{
  assert.equal(pkg.version,"3.5.2");
  assert.match(html,/目前 v3\.5\.2/);
  assert.match(html,/release-version">v3\.5\.2/);
  assert.match(sw,/lexcore-v3\.5\.2/);
});
