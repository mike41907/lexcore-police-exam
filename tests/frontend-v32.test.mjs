...
test("v3.6.0 release markers and cache version stay synchronized",()=>{
  assert.equal(pkg.version,"3.6.0");
  assert.match(html,/目前 v3\.6\.0/);
  assert.match(html,/release-version">v3\.6\.0/);
  assert.match(sw,/lexcore-v3\.6\.0/);
});
